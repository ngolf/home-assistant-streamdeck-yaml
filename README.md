...
- [| `auto_reload`     | If True, the configuration YAML file will automatically be reloaded when it is modified.                                                                                                                                                                                                  | `False`   | `bool`          |](#-auto_reload------if-true-the-configuration-yaml-file-will-automatically-be-reloaded-when-it-is-modified---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------false----bool----------)
    - [:bookmark\_tabs: Page YAML configuration](#bookmark_tabs-page-yaml-configuration)
    - [:white\_square\_button: Button YAML configuration](#white_square_button-button-yaml-configuration)
...
|:------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------|:----------------|
| `yaml_encoding`   | The encoding of the YAML file.                                                                                                                                                                                                                                                            | `utf-8`   | `Optional[str]` |
...
| `brightness`          | The default brightness of the Stream Deck (0-100).                                                                                                                                                                                                                                        | `100`     | `int`           |
| `auto_reload`         | If True, the configuration YAML file will automatically be reloaded when it is modified.                                                                                                                                                                                                  | `False`   | `bool`          |
| `long_press_duration` | The duration (in seconds) for a long press.                                                                                                                                                                                                                                               | `0.5`     | `float`         |
